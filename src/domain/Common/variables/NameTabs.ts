...
export const NameTabProduct = 'tb_product'
export const NameTabMeasure = 'tb_measure'
export const NameTabCategory = 'tb_category'
export const NameTabBasicBasket = 'tb_basic_basket'
export const NameTabBasicBasketProduct = 'tb_basic_basket_product'